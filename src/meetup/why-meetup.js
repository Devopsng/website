                ...
                <div className="row p_service_info">
                    <div className="col-lg-4 col-sm-6">
                        <div className="p_service_item pr_70">
                            ...
                            <p className="f_400">Part of the benefit of belonging to a community is the open learning culture that we have, where engineers from different organizations come and share knowledge and ideas on how to grow as a person and also how to help your organization, also you can always bring your technical and business problem to the community and you can be sure that there is always someone that has faced the challenge before.</p>
                        </div>
                    </div>
                    <div className="col-lg-4 col-sm-6">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <div className="p_service_item pl_70">
                            ...
                            <p className="f_400">One of the reasons why we started DevOps Nigeria is because we want to give back to the community and one of the ways we have been able to achieve that is by teaching and mentoring other junior and upcoming engineers that would like to become a DevOps, Cloud or Site Reliability Engineer in achieving their dream.</p>
                        </div>
                    </div>
                    {/* <div className="col-lg-4 col-sm-6">
                        <div className="p_service_item pr_70">
