                ...
                <div className="row app_service_info">
                    <div className="col-lg-4 col-sm-6">
                        <div className="app_service_item">
                            ...
                            <p className="f_400 f_size_15 mb-30">
                                We cover anything and everything about DevOps including Automation, Orchestration, Containers, Virtualisation, Service Discovery, Continuous Integration and Continuous Delivery.
                            </p>
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <div className="app_service_item">
                            ...
                            <a href="https://www.meetup.com/DevOps-Lagos-Meetup/" target="_blank" className="learn_btn_two c_violet">Join <i className="ti-arrow-right"></i></a>
                        </div>
                    </div>
                    <div className="col-lg-4 col-sm-6">
                        <div className="app_service_item">
                            ...
                            <p className="f_400 f_size_15 mb-30">
                                We cover anything and everything about DevOps including Automation, Orchestration, Containers, Virtualisation, Service Discovery, Continuous Integration and Continuous Delivery.</p>
                            <a href="https://www.meetup.com/DevOps-Lagos-Meetup/" target="_blank" className="learn_btn_two c_violet">Join <i className="ti-arrow-right"></i></a>
                        </div>
                    </div>
